  ...
  return (
    <motion.div
      ...
      <div className="p-28 flex">
        <div className="">
          <div className="flex text-xl text-accent gap-4 items-center">
            <GiTwirlyFlower />
            ABOUT US
          </div>
          <h1 className="text-6xl">Your experience is everything to us</h1>
          <div className="m-12 flex gap-8 ">
            <div className="w-1/2">
              <img src="/Images/about-03.jpg" alt="" className=" h-60" />
            </div>
            <div className="w-100">
              <p className="text-lg">
      ...
      <div className="flex px-18 py-12 ">
        ...
        <div className="flex flex-col overflow-y-auto w-1/2 px-12  overflow-x-hidden h-[70vh] justify-start">
      ...
      <div className="px-28 py-20">
        ...
        <div className="flex">
          <h1 className="w-1/2 text-6xl font-bold">
            Our team is friendly, talkative, and fully reliable.
          </h1>
          <div className="w-1/2 px-18 pt-18 text-lg">
            <p>
          ...
          <div className="flex gap-10 mt-6">
            {staffData.map((data, index) => (
              <div key={index} className="">
                <div className="w-64 h-[46vh] relative group cursor-pointer overflow-hidden rounded-xl shadow-2xl transform transition-transform duration-300 hover:scale-105">
                  <img
                    src={data.img}
                    alt={data.name}
              ...
              {/* <h3 className="text-white text-xl font-bold drop-shadow-md"></h3>
