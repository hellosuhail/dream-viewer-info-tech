...
export default function HoverCircle() {
  ...
  // Fixed base position of the circle
  const baseX = 150;
  const baseY = 400;

  // Calculate subtle movement only on hover
  ...
  return (
    ...
    >
      ...
      <span className="text-lg font-semibold items-center flex  flex-col  ">Get A Quote
        <FaArrowDown/>
      </span>
    </motion.div>
    <div className="relative left-90 top-40">
      ...
      <div className="flex items-center gap-4">
       ...
       <div className=""> <p className="text-xl block">Customer </p><span> Satisfaction</span></div>
      </div>
